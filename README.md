...
#### 2.3. Uruchomienie programu
 ...
 - Każdy sposób wymaga wykonania **fork**'a [tego](https://github.com/Aleksander2a/teoria_grafow_projekt) repozytorium **lub** pobrać zawartość [tej](https://github.com/Aleksander2a/teoria_grafow_projekt/releases/tag/v1.0) strony
